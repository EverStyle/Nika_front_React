        ...
        <>
                            ...
                            <Col className={slidingHeader.column} md={1}>
                                {
                                    tokenAvailability ?
                                        ...
                                        <div className={`${slidingHeader.accountButton} ${slidingHeader.accountProfile}`}>
                                            ...
                                            <div className={slidingHeader.accountInfo}>
                                                <ul className={slidingHeader.accountButtons}>
                                                    ...
                                                    <li>Уведомления</li>
                                                    <li className={slidingHeader.accountGoOutBtn} onClick={() => setLogOutModal(true)}>Выйти</li>
                                                </ul>
            ...
            <Modal show={logOutModal} onHide={() => setLogOutModal(false)}>
                <Modal.Header closeButton>
                    <Modal.Title>Выход из личного кабинета</Modal.Title>
                </Modal.Header>
                <Modal.Body>Вы уверены, что хотите выйти из личного кабинета?</Modal.Body>
                <Modal.Footer>
                    <Button
                        type="squre"
                        onClick={() => {
